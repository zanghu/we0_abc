...
export function Terminal({ onClose }: TerminalProps) {
  ...
  return (
    <div className={`
      ...
      [&_.xterm-viewport]:!bg-[#f9f9f9] [&_.xterm-viewport]:dark:!bg-[#1e1e1e]
      [&_.xterm-screen]:!bg-[#f9f9f9] [&_.xterm-screen]:dark:!bg-[#1e1e1e]
      [&_.xterm]:!bg-[#f9f9f9] [&_.xterm]:dark:!bg-[#1e1e1e]
      ...
      [&_.xterm-selection]:!bg-[#add6ff80] [&_.xterm-selection]:dark:!bg-[#264f78]
    `}>
      <div className="flex items-center justify-between bg-[#f3f3f3] dark:bg-[#252526] px-4 py-1 border-b border-[#e5e5e5] dark:border-[#252525]">
